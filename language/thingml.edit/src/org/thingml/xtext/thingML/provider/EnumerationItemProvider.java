...
public class EnumerationItemProvider extends TypeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.Literals.ENUMERATION__TYPE_REF);
			childrenFeatures.add(ThingMLPackage.Literals.ENUMERATION__LITERALS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.ENUMERATION__TYPE_REF,
				 ThingMLFactory.eINSTANCE.createTypeRef()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.ENUMERATION__LITERALS,
