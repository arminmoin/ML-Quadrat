...
public class ArrayIndexItemProvider extends ExpressionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.Literals.ARRAY_INDEX__ARRAY);
			childrenFeatures.add(ThingMLPackage.Literals.ARRAY_INDEX__INDEX);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.ARRAY_INDEX__ARRAY,
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.ARRAY_INDEX__INDEX,
				 ThingMLFactory.eINSTANCE.createExpression()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ThingMLPackage.Literals.ARRAY_INDEX__ARRAY ||
			childFeature == ThingMLPackage.Literals.ARRAY_INDEX__INDEX;
