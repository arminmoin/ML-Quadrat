...
public class AndExpressionItemProvider extends ExpressionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.Literals.AND_EXPRESSION__LHS);
			childrenFeatures.add(ThingMLPackage.Literals.AND_EXPRESSION__RHS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.AND_EXPRESSION__LHS,
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.AND_EXPRESSION__RHS,
				 ThingMLFactory.eINSTANCE.createExpression()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ThingMLPackage.Literals.AND_EXPRESSION__LHS ||
			childFeature == ThingMLPackage.Literals.AND_EXPRESSION__RHS;
