...
public class LoopActionItemProvider extends ActionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.Literals.LOOP_ACTION__CONDITION);
			childrenFeatures.add(ThingMLPackage.Literals.LOOP_ACTION__ACTION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.LOOP_ACTION__CONDITION,
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.LOOP_ACTION__ACTION,
