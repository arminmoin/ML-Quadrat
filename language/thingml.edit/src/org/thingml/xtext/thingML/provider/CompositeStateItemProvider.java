...
public class CompositeStateItemProvider extends StateItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.Literals.COMPOSITE_STATE__REGION);
			childrenFeatures.add(ThingMLPackage.Literals.COMPOSITE_STATE__SESSION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.COMPOSITE_STATE__REGION,
				 ThingMLFactory.eINSTANCE.createRegion()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.COMPOSITE_STATE__SESSION,
