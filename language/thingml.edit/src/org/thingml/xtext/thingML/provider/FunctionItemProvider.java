...
public class FunctionItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ThingMLPackage.Literals.FUNCTION__ABSTRACT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.Literals.FUNCTION__PARAMETERS);
			childrenFeatures.add(ThingMLPackage.Literals.FUNCTION__TYPE_REF);
			childrenFeatures.add(ThingMLPackage.Literals.FUNCTION__BODY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.FUNCTION__PARAMETERS,
				 ThingMLFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.FUNCTION__TYPE_REF,
				 ThingMLFactory.eINSTANCE.createTypeRef()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.FUNCTION__BODY,
