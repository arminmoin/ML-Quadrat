...
public class VariableAssignmentItemProvider extends ActionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ThingMLPackage.Literals.VARIABLE_ASSIGNMENT__PROPERTY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.Literals.VARIABLE_ASSIGNMENT__INDEX);
			childrenFeatures.add(ThingMLPackage.Literals.VARIABLE_ASSIGNMENT__EXPRESSION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.VARIABLE_ASSIGNMENT__INDEX,
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.Literals.VARIABLE_ASSIGNMENT__EXPRESSION,
				 ThingMLFactory.eINSTANCE.createExpression()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ThingMLPackage.Literals.VARIABLE_ASSIGNMENT__INDEX ||
			childFeature == ThingMLPackage.Literals.VARIABLE_ASSIGNMENT__EXPRESSION;
