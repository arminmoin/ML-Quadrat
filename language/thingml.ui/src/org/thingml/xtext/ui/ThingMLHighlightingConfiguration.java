...
public class ThingMLHighlightingConfiguration extends DefaultHighlightingConfiguration {
	...
	public static final String DATA_ANALYTICS_ID = "DATA_ANALYTICS_ID";
    ...
    public void configure(IHighlightingConfigurationAcceptor acceptor) {
        ...
        acceptor.acceptDefaultHighlighting(DATA_ANALYTICS_ID, "DATA_ANALYTICS_ID", data_analytics());
    }
	...
	protected TextStyle data_analytics() {
        TextStyle textStyle = defaultTextStyle().copy();
