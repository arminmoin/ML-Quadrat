 ...
 * </p>
 * <ul>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestImpl#getLossFunction <em>Loss Function</em>}</li>
...
public class RandomForestImpl extends ML2_ModelAlgorithmImpl implements RandomForest
{
		...
		public void setLossFunction(LossFunction newLossFunction)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST__LOSS_FUNCTION, oldLossFunction, lossFunction));
	}
  ...
  public NotificationChain basicSetMin_samples_split(MinSamplesSplit newMin_samples_split, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST__MIN_SAMPLES_SPLIT, oldMin_samples_split, newMin_samples_split);
		...
		public void setMin_samples_split(MinSamplesSplit newMin_samples_split)
  {
		if (newMin_samples_split != min_samples_split) {
			...
			if (min_samples_split != null)
				msgs = ((InternalEObject)min_samples_split).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST__MIN_SAMPLES_SPLIT, null, msgs);
			if (newMin_samples_split != null)
				msgs = ((InternalEObject)newMin_samples_split).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST__MIN_SAMPLES_SPLIT, null, msgs);
			msgs = basicSetMin_samples_split(newMin_samples_split, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST__MIN_SAMPLES_SPLIT, newMin_samples_split, newMin_samples_split));
	}
  ...
  {
		switch (featureID) {
			case ThingMLPackage.RANDOM_FOREST__LOSS_FUNCTION:
