...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gated Recurrent Units</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.thingml.xtext.thingML.impl.GatedRecurrentUnitsImpl#getLoss_function <em>Loss function</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.GatedRecurrentUnitsImpl#getOptimizer <em>Optimizer</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.GatedRecurrentUnitsImpl#getLearning_rate <em>Learning rate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GatedRecurrentUnitsImpl extends ML2_ModelAlgorithmImpl implements GatedRecurrentUnits
{
  /**
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  protected GatedRecurrentUnitsImpl()
  {
		super();
	}
  ...
  {
		return ThingMLPackage.Literals.GATED_RECURRENT_UNITS;
	}
		...
		public void setLoss_function(LossFunction newLoss_function)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.GATED_RECURRENT_UNITS__LOSS_FUNCTION, oldLoss_function, loss_function));
	}
		...
		public void setOptimizer(Optimizer newOptimizer)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.GATED_RECURRENT_UNITS__OPTIMIZER, oldOptimizer, optimizer));
	}
		...
		public void setLearning_rate(double newLearning_rate)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.GATED_RECURRENT_UNITS__LEARNING_RATE, oldLearning_rate, learning_rate));
	}
