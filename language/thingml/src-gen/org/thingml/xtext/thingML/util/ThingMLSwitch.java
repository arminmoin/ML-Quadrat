...
public class ThingMLSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
		switch (classifierID) {
			...
			case ThingMLPackage.DECISION_TREE: {
				DecisionTree decisionTree = (DecisionTree)theEObject;
				T result = caseDecisionTree(decisionTree);
				if (result == null) result = caseML2_ModelAlgorithm(decisionTree);
				if (result == null) result = caseDataAnalyticsModelAlgorithm(decisionTree);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ThingMLPackage.RANDOM_FOREST: {
				RandomForest randomForest = (RandomForest)theEObject;
				T result = caseRandomForest(randomForest);
				if (result == null) result = caseML2_ModelAlgorithm(randomForest);
				if (result == null) result = caseDataAnalyticsModelAlgorithm(randomForest);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
