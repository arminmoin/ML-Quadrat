...
public class ThingMLScopeProvider extends AbstractThingMLScopeProvider {
                                                          ...
                                                          if (_equals_24) {
                                                            ...
                                                            if (_equals_25) {
                                                              ...
                                                              if ((((Objects.equal(reference, this.p.getConfigPropertyAssign_Instance()) || Objects.equal(reference, this.p.getConnector_Cli())) || Objects.equal(reference, this.p.getConnector_Srv())) || Objects.equal(reference, this.p.getExternalConnector_Inst()))) {
                                                                ...
                                                                EReference _dASaveAction_DataAnalytics = this.p.getDASaveAction_DataAnalytics();
                                                                boolean _equals_26 = Objects.equal(reference, _dASaveAction_DataAnalytics);
                                                                if (_equals_26) {
                                                                  return this.scopeForDataAnalyticsSaveAction(((DASaveAction) context));
                                                                } else {
                                                                  EReference _dAPreprocessAction_DataAnalytics = this.p.getDAPreprocessAction_DataAnalytics();
                                                                  boolean _equals_27 = Objects.equal(reference, _dAPreprocessAction_DataAnalytics);
                                                                  if (_equals_27) {
                                                                    return this.scopeForDataAnalyticsPreprocessAction(((DAPreprocessAction) context));
                                                                  } else {
                                                                    EReference _dATrainAction_DataAnalytics = this.p.getDATrainAction_DataAnalytics();
                                                                    boolean _equals_28 = Objects.equal(reference, _dATrainAction_DataAnalytics);
                                                                    if (_equals_28) {
                                                                      return this.scopeForDataAnalyticsTrainAction(((DATrainAction) context));
                                                                    } else {
                                                                      EReference _dAPredictAction_DataAnalytics = this.p.getDAPredictAction_DataAnalytics();
                                                                      boolean _equals_29 = Objects.equal(reference, _dAPredictAction_DataAnalytics);
                                                                      if (_equals_29) {
                                                                        return this.scopeForDataAnalyticsPredictAction(((DAPredictAction) context));
                                                                      } else {
                                                                        EReference _dAPredictAction_Features = this.p.getDAPredictAction_Features();
                                                                        boolean _equals_30 = Objects.equal(reference, _dAPredictAction_Features);
                                                                        if (_equals_30) {
                                                                          return this.scopeForDataAnalyticsPredictActionFeatures(((DAPredictAction) context));
                                                                        } else {
                                                                          EReference _dataAnalytics_Features = this.p.getDataAnalytics_Features();
                                                                          boolean _equals_31 = Objects.equal(reference, _dataAnalytics_Features);
                                                                          if (_equals_31) {
                                                                            return this.scopeForDataAnalyticsFeatures(((DataAnalytics) context));
                                                                          } else {
                                                                            EReference _dataAnalytics_PredictionResults = this.p.getDataAnalytics_PredictionResults();
                                                                            boolean _equals_32 = Objects.equal(reference, _dataAnalytics_PredictionResults);
                                                                            if (_equals_32) {
                                                                              return this.scopeForDataAnalyticsPredictionResults(((DataAnalytics) context));
                                                                            } else {
  ...
  protected IScope scopeForDataAnalyticsSaveAction(final DASaveAction context) {
    return Scopes.scopeFor(ThingMLHelpers.allDataAnalytics(ThingMLHelpers.findContainingThing(context)));
  }
  
  protected IScope scopeForDataAnalyticsPreprocessAction(final DAPreprocessAction context) {
    return Scopes.scopeFor(ThingMLHelpers.allDataAnalytics(ThingMLHelpers.findContainingThing(context)));
  }
  
  protected IScope scopeForDataAnalyticsTrainAction(final DATrainAction context) {
    return Scopes.scopeFor(ThingMLHelpers.allDataAnalytics(ThingMLHelpers.findContainingThing(context)));
  }
  
  protected IScope scopeForDataAnalyticsPredictAction(final DAPredictAction context) {
    return Scopes.scopeFor(ThingMLHelpers.allDataAnalytics(ThingMLHelpers.findContainingThing(context)));
  }
  
  protected IScope scopeForDataAnalyticsPredictActionFeatures(final DAPredictAction context) {
    return Scopes.scopeFor(ThingMLHelpers.allProperties(ThingMLHelpers.findContainingThing(context)));
  }
  
  protected IScope scopeForDataAnalyticsFeatures(final DataAnalytics context) {
    EObject _eContainer = context.eContainer();
    return Scopes.scopeFor(ThingMLHelpers.allProperties(((Thing) _eContainer)));
  }
  
  protected IScope scopeForDataAnalyticsPredictionResults(final DataAnalytics context) {
    EObject _eContainer = context.eContainer();
    return Scopes.scopeFor(ThingMLHelpers.allProperties(((Thing) _eContainer)));
  }
