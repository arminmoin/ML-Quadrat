 ...
 */
public class PythonJavaCompiler extends OpaqueThingMLCompiler {

    public PythonJavaCompiler() {
        super(new PythonJavaThingActionCompiler(), new PythonJavaThingApiCompiler(), new PythonJavaCfgMainGenerator(),
                new PythonJavaCfgBuildCompiler(), new PythonJavaThingImplCompiler());
        connectorCompilers.clear();
        connectorCompilers.put("swing", new PythonJava2Swing());
    }

    public PythonJavaCompiler(PythonJavaThingActionCompiler javaThingActionCompiler, PythonJavaThingApiCompiler javaThingApiCompiler,
			PythonJavaCfgMainGenerator javaCfgMainGenerator, PythonJavaCfgBuildCompiler javaCfgBuildCompiler,
			PythonJavaThingImplCompiler javaThingImplCompiler) {
    ...
    public String getDescription() {
        return "Generates Python and Java code.";
    }
    ...
    public boolean do_call_compiler(Configuration cfg, Logger log, String... options) {
        ...
        if (doingTests) {
            tmpFolder = "tmp/ThingML_PythonJava/";
        }
