...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Random Forest Regressor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getN_estimators <em>Nestimators</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getRandomForestRegressorCriterion <em>Random Forest Regressor Criterion</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getMax_depth <em>Max depth</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getMin_samples_split <em>Min samples split</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getMin_samples_leaf <em>Min samples leaf</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getMin_weight_fraction_leaf <em>Min weight fraction leaf</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getMax_features_numeric <em>Max features numeric</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getMax_features_enum <em>Max features enum</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getMax_leaf_nodes <em>Max leaf nodes</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getMin_impurity_decrease <em>Min impurity decrease</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getMin_impurity_split <em>Min impurity split</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getBootstrap <em>Bootstrap</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getOob_score <em>Oob score</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getN_jobs <em>Njobs</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getRandom_state <em>Random state</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getVerbose <em>Verbose</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getWarm_start <em>Warm start</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getCcp_alpha <em>Ccp alpha</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.RandomForestRegressorImpl#getMax_samples <em>Max samples</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RandomForestRegressorImpl extends ML2_ModelAlgorithmImpl implements RandomForestRegressor
{
  /**
  ...
  /**
   * The default value of the '{@link #getRandomForestRegressorCriterion() <em>Random Forest Regressor Criterion</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @ordered
   */
  protected static final RandomForestRegressorCriterion RANDOM_FOREST_REGRESSOR_CRITERION_EDEFAULT = RandomForestRegressorCriterion.NOT_SET;

  /**
   * The cached value of the '{@link #getRandomForestRegressorCriterion() <em>Random Forest Regressor Criterion</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getRandomForestRegressorCriterion()
   * @generated
   * @ordered
   */
  protected RandomForestRegressorCriterion randomForestRegressorCriterion = RANDOM_FOREST_REGRESSOR_CRITERION_EDEFAULT;
   ...
   * @generated
   */
  protected RandomForestRegressorImpl()
  {
    super();
  }
  ...
  {
    return ThingMLPackage.eINSTANCE.getRandomForestRegressor();
  }
  ...
  public NotificationChain basicSetN_estimators(IntegerLiteral newN_estimators, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__NESTIMATORS, oldN_estimators, newN_estimators);
  ...
  public void setN_estimators(IntegerLiteral newN_estimators)
  {
    if (newN_estimators != n_estimators)
    {
      ...
      if (n_estimators != null)
        msgs = ((InternalEObject)n_estimators).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__NESTIMATORS, null, msgs);
      if (newN_estimators != null)
        msgs = ((InternalEObject)newN_estimators).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__NESTIMATORS, null, msgs);
      msgs = basicSetN_estimators(newN_estimators, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__NESTIMATORS, newN_estimators, newN_estimators));
  }
   ...
   * @generated
   */
  public RandomForestRegressorCriterion getRandomForestRegressorCriterion()
  {
    return randomForestRegressorCriterion;
  }
   ...
   * @generated
   */
  public void setRandomForestRegressorCriterion(RandomForestRegressorCriterion newRandomForestRegressorCriterion)
  {
    RandomForestRegressorCriterion oldRandomForestRegressorCriterion = randomForestRegressorCriterion;
    randomForestRegressorCriterion = newRandomForestRegressorCriterion == null ? RANDOM_FOREST_REGRESSOR_CRITERION_EDEFAULT : newRandomForestRegressorCriterion;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__RANDOM_FOREST_REGRESSOR_CRITERION, oldRandomForestRegressorCriterion, randomForestRegressorCriterion));
  }
  ...
  public NotificationChain basicSetMax_depth(IntegerLiteral newMax_depth, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_DEPTH, oldMax_depth, newMax_depth);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMax_depth(IntegerLiteral newMax_depth)
  {
    if (newMax_depth != max_depth)
    {
      NotificationChain msgs = null;
      if (max_depth != null)
        msgs = ((InternalEObject)max_depth).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_DEPTH, null, msgs);
      if (newMax_depth != null)
        msgs = ((InternalEObject)newMax_depth).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_DEPTH, null, msgs);
      msgs = basicSetMax_depth(newMax_depth, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_DEPTH, newMax_depth, newMax_depth));
  }
  ...
  public NotificationChain basicSetMin_samples_split(DoubleLiteral newMin_samples_split, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_SAMPLES_SPLIT, oldMin_samples_split, newMin_samples_split);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMin_samples_split(DoubleLiteral newMin_samples_split)
  {
    if (newMin_samples_split != min_samples_split)
    {
      ...
      if (min_samples_split != null)
        msgs = ((InternalEObject)min_samples_split).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_SAMPLES_SPLIT, null, msgs);
      if (newMin_samples_split != null)
        msgs = ((InternalEObject)newMin_samples_split).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_SAMPLES_SPLIT, null, msgs);
      msgs = basicSetMin_samples_split(newMin_samples_split, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_SAMPLES_SPLIT, newMin_samples_split, newMin_samples_split));
  }
  ...
  public NotificationChain basicSetMin_samples_leaf(DoubleLiteral newMin_samples_leaf, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_SAMPLES_LEAF, oldMin_samples_leaf, newMin_samples_leaf);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMin_samples_leaf(DoubleLiteral newMin_samples_leaf)
  {
    if (newMin_samples_leaf != min_samples_leaf)
    {
      ...
      if (min_samples_leaf != null)
        msgs = ((InternalEObject)min_samples_leaf).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_SAMPLES_LEAF, null, msgs);
      if (newMin_samples_leaf != null)
        msgs = ((InternalEObject)newMin_samples_leaf).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_SAMPLES_LEAF, null, msgs);
      msgs = basicSetMin_samples_leaf(newMin_samples_leaf, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_SAMPLES_LEAF, newMin_samples_leaf, newMin_samples_leaf));
  }
  ...
  public NotificationChain basicSetMin_weight_fraction_leaf(DoubleLiteral newMin_weight_fraction_leaf, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_WEIGHT_FRACTION_LEAF, oldMin_weight_fraction_leaf, newMin_weight_fraction_leaf);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMin_weight_fraction_leaf(DoubleLiteral newMin_weight_fraction_leaf)
  {
    if (newMin_weight_fraction_leaf != min_weight_fraction_leaf)
    {
      ...
      if (min_weight_fraction_leaf != null)
        msgs = ((InternalEObject)min_weight_fraction_leaf).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_WEIGHT_FRACTION_LEAF, null, msgs);
      if (newMin_weight_fraction_leaf != null)
        msgs = ((InternalEObject)newMin_weight_fraction_leaf).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_WEIGHT_FRACTION_LEAF, null, msgs);
      msgs = basicSetMin_weight_fraction_leaf(newMin_weight_fraction_leaf, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_WEIGHT_FRACTION_LEAF, newMin_weight_fraction_leaf, newMin_weight_fraction_leaf));
  }
  ...
  public NotificationChain basicSetMax_features_numeric(DoubleLiteral newMax_features_numeric, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_FEATURES_NUMERIC, oldMax_features_numeric, newMax_features_numeric);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMax_features_numeric(DoubleLiteral newMax_features_numeric)
  {
    if (newMax_features_numeric != max_features_numeric)
    {
      ...
      if (max_features_numeric != null)
        msgs = ((InternalEObject)max_features_numeric).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_FEATURES_NUMERIC, null, msgs);
      if (newMax_features_numeric != null)
        msgs = ((InternalEObject)newMax_features_numeric).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_FEATURES_NUMERIC, null, msgs);
      msgs = basicSetMax_features_numeric(newMax_features_numeric, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_FEATURES_NUMERIC, newMax_features_numeric, newMax_features_numeric));
  }
  ...
  public void setMax_features_enum(Max_features_enum newMax_features_enum)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_FEATURES_ENUM, oldMax_features_enum, max_features_enum));
  }
  ...
  public NotificationChain basicSetMax_leaf_nodes(IntegerLiteral newMax_leaf_nodes, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_LEAF_NODES, oldMax_leaf_nodes, newMax_leaf_nodes);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMax_leaf_nodes(IntegerLiteral newMax_leaf_nodes)
  {
    if (newMax_leaf_nodes != max_leaf_nodes)
    {
      ...
      if (max_leaf_nodes != null)
        msgs = ((InternalEObject)max_leaf_nodes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_LEAF_NODES, null, msgs);
      if (newMax_leaf_nodes != null)
        msgs = ((InternalEObject)newMax_leaf_nodes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_LEAF_NODES, null, msgs);
      msgs = basicSetMax_leaf_nodes(newMax_leaf_nodes, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_LEAF_NODES, newMax_leaf_nodes, newMax_leaf_nodes));
  }
  ...
  public NotificationChain basicSetMin_impurity_decrease(DoubleLiteral newMin_impurity_decrease, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_IMPURITY_DECREASE, oldMin_impurity_decrease, newMin_impurity_decrease);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMin_impurity_decrease(DoubleLiteral newMin_impurity_decrease)
  {
    if (newMin_impurity_decrease != min_impurity_decrease)
    {
      ...
      if (min_impurity_decrease != null)
        msgs = ((InternalEObject)min_impurity_decrease).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_IMPURITY_DECREASE, null, msgs);
      if (newMin_impurity_decrease != null)
        msgs = ((InternalEObject)newMin_impurity_decrease).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_IMPURITY_DECREASE, null, msgs);
      msgs = basicSetMin_impurity_decrease(newMin_impurity_decrease, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_IMPURITY_DECREASE, newMin_impurity_decrease, newMin_impurity_decrease));
  }
  ...
  public NotificationChain basicSetMin_impurity_split(DoubleLiteral newMin_impurity_split, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_IMPURITY_SPLIT, oldMin_impurity_split, newMin_impurity_split);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMin_impurity_split(DoubleLiteral newMin_impurity_split)
  {
    if (newMin_impurity_split != min_impurity_split)
    {
      ...
      if (min_impurity_split != null)
        msgs = ((InternalEObject)min_impurity_split).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_IMPURITY_SPLIT, null, msgs);
      if (newMin_impurity_split != null)
        msgs = ((InternalEObject)newMin_impurity_split).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_IMPURITY_SPLIT, null, msgs);
      msgs = basicSetMin_impurity_split(newMin_impurity_split, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_IMPURITY_SPLIT, newMin_impurity_split, newMin_impurity_split));
  }
  ...
  public NotificationChain basicSetBootstrap(BooleanLiteral newBootstrap, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__BOOTSTRAP, oldBootstrap, newBootstrap);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setBootstrap(BooleanLiteral newBootstrap)
  {
    if (newBootstrap != bootstrap)
    {
      NotificationChain msgs = null;
      if (bootstrap != null)
        msgs = ((InternalEObject)bootstrap).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__BOOTSTRAP, null, msgs);
      if (newBootstrap != null)
        msgs = ((InternalEObject)newBootstrap).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__BOOTSTRAP, null, msgs);
      msgs = basicSetBootstrap(newBootstrap, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__BOOTSTRAP, newBootstrap, newBootstrap));
  }
  ...
  public NotificationChain basicSetOob_score(BooleanLiteral newOob_score, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__OOB_SCORE, oldOob_score, newOob_score);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOob_score(BooleanLiteral newOob_score)
  {
    if (newOob_score != oob_score)
    {
      NotificationChain msgs = null;
      if (oob_score != null)
        msgs = ((InternalEObject)oob_score).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__OOB_SCORE, null, msgs);
      if (newOob_score != null)
        msgs = ((InternalEObject)newOob_score).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__OOB_SCORE, null, msgs);
      msgs = basicSetOob_score(newOob_score, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__OOB_SCORE, newOob_score, newOob_score));
  }
  ...
  public NotificationChain basicSetN_jobs(IntegerLiteral newN_jobs, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__NJOBS, oldN_jobs, newN_jobs);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setN_jobs(IntegerLiteral newN_jobs)
  {
    if (newN_jobs != n_jobs)
    {
      NotificationChain msgs = null;
      if (n_jobs != null)
        msgs = ((InternalEObject)n_jobs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__NJOBS, null, msgs);
      if (newN_jobs != null)
        msgs = ((InternalEObject)newN_jobs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__NJOBS, null, msgs);
      msgs = basicSetN_jobs(newN_jobs, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__NJOBS, newN_jobs, newN_jobs));
  }
  ...
  public NotificationChain basicSetRandom_state(IntegerLiteral newRandom_state, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__RANDOM_STATE, oldRandom_state, newRandom_state);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRandom_state(IntegerLiteral newRandom_state)
  {
    if (newRandom_state != random_state)
    {
      ...
      if (random_state != null)
        msgs = ((InternalEObject)random_state).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__RANDOM_STATE, null, msgs);
      if (newRandom_state != null)
        msgs = ((InternalEObject)newRandom_state).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__RANDOM_STATE, null, msgs);
      msgs = basicSetRandom_state(newRandom_state, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__RANDOM_STATE, newRandom_state, newRandom_state));
  }
  ...
  public NotificationChain basicSetVerbose(IntegerLiteral newVerbose, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__VERBOSE, oldVerbose, newVerbose);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setVerbose(IntegerLiteral newVerbose)
  {
    if (newVerbose != verbose)
    {
      NotificationChain msgs = null;
      if (verbose != null)
        msgs = ((InternalEObject)verbose).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__VERBOSE, null, msgs);
      if (newVerbose != null)
        msgs = ((InternalEObject)newVerbose).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__VERBOSE, null, msgs);
      msgs = basicSetVerbose(newVerbose, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__VERBOSE, newVerbose, newVerbose));
  }
  ...
  public NotificationChain basicSetWarm_start(BooleanLiteral newWarm_start, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__WARM_START, oldWarm_start, newWarm_start);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setWarm_start(BooleanLiteral newWarm_start)
  {
    if (newWarm_start != warm_start)
    {
      NotificationChain msgs = null;
      if (warm_start != null)
        msgs = ((InternalEObject)warm_start).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__WARM_START, null, msgs);
      if (newWarm_start != null)
        msgs = ((InternalEObject)newWarm_start).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__WARM_START, null, msgs);
      msgs = basicSetWarm_start(newWarm_start, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__WARM_START, newWarm_start, newWarm_start));
  }
  ...
  public NotificationChain basicSetCcp_alpha(DoubleLiteral newCcp_alpha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__CCP_ALPHA, oldCcp_alpha, newCcp_alpha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCcp_alpha(DoubleLiteral newCcp_alpha)
  {
    if (newCcp_alpha != ccp_alpha)
    {
      NotificationChain msgs = null;
      if (ccp_alpha != null)
        msgs = ((InternalEObject)ccp_alpha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__CCP_ALPHA, null, msgs);
      if (newCcp_alpha != null)
        msgs = ((InternalEObject)newCcp_alpha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__CCP_ALPHA, null, msgs);
      msgs = basicSetCcp_alpha(newCcp_alpha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__CCP_ALPHA, newCcp_alpha, newCcp_alpha));
  }
  ...
  public NotificationChain basicSetMax_samples(DoubleLiteral newMax_samples, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_SAMPLES, oldMax_samples, newMax_samples);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMax_samples(DoubleLiteral newMax_samples)
  {
    if (newMax_samples != max_samples)
    {
      NotificationChain msgs = null;
      if (max_samples != null)
        msgs = ((InternalEObject)max_samples).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_SAMPLES, null, msgs);
      if (newMax_samples != null)
        msgs = ((InternalEObject)newMax_samples).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_SAMPLES, null, msgs);
      msgs = basicSetMax_samples(newMax_samples, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_SAMPLES, newMax_samples, newMax_samples));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ThingMLPackage.RANDOM_FOREST_REGRESSOR__RANDOM_FOREST_REGRESSOR_CRITERION:
        return getRandomForestRegressorCriterion();
      case ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_DEPTH:
        return getMax_depth();
      case ThingMLPackage.RANDOM_FOREST_REGRESSOR__MIN_SAMPLES_SPLIT:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case ThingMLPackage.RANDOM_FOREST_REGRESSOR__NESTIMATORS:
        ...
        return;
      case ThingMLPackage.RANDOM_FOREST_REGRESSOR__RANDOM_FOREST_REGRESSOR_CRITERION:
        setRandomForestRegressorCriterion((RandomForestRegressorCriterion)newValue);
        return;
      case ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_DEPTH:
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      case ThingMLPackage.RANDOM_FOREST_REGRESSOR__NESTIMATORS:
        ...
        return;
      case ThingMLPackage.RANDOM_FOREST_REGRESSOR__RANDOM_FOREST_REGRESSOR_CRITERION:
        setRandomForestRegressorCriterion(RANDOM_FOREST_REGRESSOR_CRITERION_EDEFAULT);
        return;
      case ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_DEPTH:
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case ThingMLPackage.RANDOM_FOREST_REGRESSOR__RANDOM_FOREST_REGRESSOR_CRITERION:
        return randomForestRegressorCriterion != RANDOM_FOREST_REGRESSOR_CRITERION_EDEFAULT;
      case ThingMLPackage.RANDOM_FOREST_REGRESSOR__MAX_DEPTH:
  ...
  public String toString()
  {
    ...
    result.append(" (randomForestRegressorCriterion: ");
    result.append(randomForestRegressorCriterion);
