 ...
 * </p>
 * <ul>
 *   <li>{@link org.thingml.xtext.thingML.impl.PrintActionImpl#isLine <em>Line</em>}</li>
...
public class PrintActionImpl extends ActionImpl implements PrintAction
{
  ...
  {
    return ThingMLPackage.eINSTANCE.getPrintAction();
  }
  ...
  public void setLine(boolean newLine)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.PRINT_ACTION__LINE, oldLine, line));
  }
  ...
  public EList<Expression> getMsg()
  {
    if (msg == null)
    {
      msg = new EObjectContainmentEList<Expression>(Expression.class, this, ThingMLPackage.PRINT_ACTION__MSG);
    }
    return msg;
  }
