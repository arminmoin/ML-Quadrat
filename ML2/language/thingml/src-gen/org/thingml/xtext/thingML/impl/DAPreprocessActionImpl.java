...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DA Preprocess Action</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.thingml.xtext.thingML.impl.DAPreprocessActionImpl#getDataAnalytics <em>Data Analytics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DAPreprocessActionImpl extends ActionImpl implements DAPreprocessAction
{
  /**
   ...
   * @generated
   */
  protected DAPreprocessActionImpl()
  {
    super();
  }
  ...
  {
    return ThingMLPackage.eINSTANCE.getDAPreprocessAction();
  }
    ...
    if (dataAnalytics != null && dataAnalytics.eIsProxy())
    {
      ...
      if (dataAnalytics != oldDataAnalytics)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ThingMLPackage.DA_PREPROCESS_ACTION__DATA_ANALYTICS, oldDataAnalytics, dataAnalytics));
      }
    }
  ...
  public void setDataAnalytics(DataAnalytics newDataAnalytics)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.DA_PREPROCESS_ACTION__DATA_ANALYTICS, oldDataAnalytics, dataAnalytics));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ThingMLPackage.DA_PREPROCESS_ACTION__DATA_ANALYTICS:
