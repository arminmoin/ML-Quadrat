 ...
 *   <li>{@link org.thingml.xtext.thingML.impl.ThingImpl#getDataAnalytics <em>Data Analytics</em>}</li>
...
public class ThingImpl extends TypeImpl implements Thing
{
  ...
  /**
   * The cached value of the '{@link #getDataAnalytics() <em>Data Analytics</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @ordered
   */
  protected EList<DataAnalytics> dataAnalytics;
  ...
  {
    return ThingMLPackage.eINSTANCE.getThing();
  }
   ...
   * @generated
   */
  public EList<DataAnalytics> getDataAnalytics()
  {
    if (dataAnalytics == null)
    {
      dataAnalytics = new EObjectContainmentEList<DataAnalytics>(DataAnalytics.class, this, ThingMLPackage.THING__DATA_ANALYTICS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case ThingMLPackage.THING__DATA_ANALYTICS:
        return ((InternalEList<?>)getDataAnalytics()).basicRemove(otherEnd, msgs);
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case ThingMLPackage.THING__ASSIGN:
        ...
        return;
      case ThingMLPackage.THING__DATA_ANALYTICS:
        getDataAnalytics().clear();
        getDataAnalytics().addAll((Collection<? extends DataAnalytics>)newValue);
        return;
      case ThingMLPackage.THING__BEHAVIOUR:
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case ThingMLPackage.THING__DATA_ANALYTICS:
        return dataAnalytics != null && !dataAnalytics.isEmpty();
      case ThingMLPackage.THING__BEHAVIOUR:
