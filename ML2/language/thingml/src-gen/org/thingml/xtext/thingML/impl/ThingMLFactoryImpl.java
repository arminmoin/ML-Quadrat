...
public class ThingMLFactoryImpl extends EFactoryImpl implements ThingMLFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case ThingMLPackage.PRETRAINED_ML_MODEL: return createPretrained_ML_Model();
  ...
  public Object createFromString(EDataType eDataType, String initialValue)
  {
    switch (eDataType.getClassifierID())
    {
      ...
      case ThingMLPackage.PREPROCESS_FEATURE_SCALING:
        return createPreprocess_feature_scalingFromString(eDataType, initialValue);
  ...
  public String convertToString(EDataType eDataType, Object instanceValue)
  {
    switch (eDataType.getClassifierID())
    {
      ...
      case ThingMLPackage.PREPROCESS_FEATURE_SCALING:
        return convertPreprocess_feature_scalingToString(eDataType, instanceValue);
      case ThingMLPackage.PENALTY:
   ...
   * @generated
   */
  public Pretrained_ML_Model createPretrained_ML_Model()
  {
    Pretrained_ML_ModelImpl pretrained_ML_Model = new Pretrained_ML_ModelImpl();
    return pretrained_ML_Model;
  }
   ...
   * @generated
   */
  public Preprocess_feature_scaling createPreprocess_feature_scalingFromString(EDataType eDataType, String initialValue)
  {
    Preprocess_feature_scaling result = Preprocess_feature_scaling.get(initialValue);
    if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
    return result;
  }
   ...
   * @generated
   */
  public String convertPreprocess_feature_scalingToString(EDataType eDataType, Object instanceValue)
  {
    return instanceValue == null ? null : instanceValue.toString();
  }
