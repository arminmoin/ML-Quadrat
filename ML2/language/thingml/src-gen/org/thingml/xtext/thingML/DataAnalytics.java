 ...
 *   <li>{@link org.thingml.xtext.thingML.DataAnalytics#getPreprocess_feature_scaling <em>Preprocess feature scaling</em>}</li>
...
public interface DataAnalytics extends NamedElement, AnnotatedElement
{
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Auto ML</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the value of the '<em><b>Preprocess feature scaling</b></em>' attribute.
   * The literals are from the enumeration {@link org.thingml.xtext.thingML.Preprocess_feature_scaling}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Preprocess feature scaling</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Preprocess feature scaling</em>' attribute.
   * @see org.thingml.xtext.thingML.Preprocess_feature_scaling
   * @see #setPreprocess_feature_scaling(Preprocess_feature_scaling)
   * @see org.thingml.xtext.thingML.ThingMLPackage#getDataAnalytics_Preprocess_feature_scaling()
   * @model
   * @generated
   */
  Preprocess_feature_scaling getPreprocess_feature_scaling();

  /**
   * Sets the value of the '{@link org.thingml.xtext.thingML.DataAnalytics#getPreprocess_feature_scaling <em>Preprocess feature scaling</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Preprocess feature scaling</em>' attribute.
   * @see org.thingml.xtext.thingML.Preprocess_feature_scaling
   * @see #getPreprocess_feature_scaling()
   * @generated
   */
  void setPreprocess_feature_scaling(Preprocess_feature_scaling value);
