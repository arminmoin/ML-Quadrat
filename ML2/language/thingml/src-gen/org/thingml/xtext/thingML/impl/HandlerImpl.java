...
public class HandlerImpl extends NamedElementImpl implements Handler
{
  ...
  {
    return ThingMLPackage.eINSTANCE.getHandler();
  }
  ...
  public NotificationChain basicSetEvent(Event newEvent, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.HANDLER__EVENT, oldEvent, newEvent);
  ...
  public void setEvent(Event newEvent)
  {
    if (newEvent != event)
    {
      ...
      if (event != null)
        msgs = ((InternalEObject)event).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.HANDLER__EVENT, null, msgs);
      if (newEvent != null)
        msgs = ((InternalEObject)newEvent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.HANDLER__EVENT, null, msgs);
      msgs = basicSetEvent(newEvent, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.HANDLER__EVENT, newEvent, newEvent));
  }
