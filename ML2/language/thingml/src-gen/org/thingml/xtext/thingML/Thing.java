 ...
 *   <li>{@link org.thingml.xtext.thingML.Thing#getDataAnalytics <em>Data Analytics</em>}</li>
...
public interface Thing extends Type
{
  ...
  /**
   * Returns the value of the '<em><b>Data Analytics</b></em>' containment reference list.
   * The list contents are of type {@link org.thingml.xtext.thingML.DataAnalytics}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Data Analytics</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Data Analytics</em>' containment reference list.
   * @see org.thingml.xtext.thingML.ThingMLPackage#getThing_DataAnalytics()
   * @model containment="true"
   * @generated
   */
  EList<DataAnalytics> getDataAnalytics();
