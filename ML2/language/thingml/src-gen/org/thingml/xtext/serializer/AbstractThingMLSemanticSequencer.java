...
public abstract class AbstractThingMLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_ByteLiteral(ISerializationContext context, ByteLiteral semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ThingMLPackage.Literals.BYTE_LITERAL__BYTE_VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ThingMLPackage.Literals.BYTE_LITERAL__BYTE_VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_CharLiteral(ISerializationContext context, CharLiteral semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ThingMLPackage.Literals.CHAR_LITERAL__CHAR_VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ThingMLPackage.Literals.CHAR_LITERAL__CHAR_VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_DAPreprocessAction(ISerializationContext context, DAPreprocessAction semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ThingMLPackage.Literals.DA_PREPROCESS_ACTION__DATA_ANALYTICS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ThingMLPackage.Literals.DA_PREPROCESS_ACTION__DATA_ANALYTICS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDAPreprocessActionAccess().getDataAnalyticsDataAnalyticsIDTerminalRuleCall_1_0_1(), semanticObject.eGet(ThingMLPackage.Literals.DA_PREPROCESS_ACTION__DATA_ANALYTICS, false));
		feeder.finish();
	}
	...
	protected void sequence_DASaveAction(ISerializationContext context, DASaveAction semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ThingMLPackage.Literals.DA_SAVE_ACTION__DATA_ANALYTICS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ThingMLPackage.Literals.DA_SAVE_ACTION__DATA_ANALYTICS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDASaveActionAccess().getDataAnalyticsDataAnalyticsIDTerminalRuleCall_1_0_1(), semanticObject.eGet(ThingMLPackage.Literals.DA_SAVE_ACTION__DATA_ANALYTICS, false));
		feeder.finish();
	}
	...
	protected void sequence_DATrainAction(ISerializationContext context, DATrainAction semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ThingMLPackage.Literals.DA_TRAIN_ACTION__DATA_ANALYTICS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ThingMLPackage.Literals.DA_TRAIN_ACTION__DATA_ANALYTICS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDATrainActionAccess().getDataAnalyticsDataAnalyticsIDTerminalRuleCall_1_0_1(), semanticObject.eGet(ThingMLPackage.Literals.DA_TRAIN_ACTION__DATA_ANALYTICS, false));
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     DataAnalyticsModelAlgorithm returns DecisionTree
	 *     ML2_ModelAlgorithm returns DecisionTree
	...
	protected void sequence_PFA_ModelAlgorithm(ISerializationContext context, PFA_ModelAlgorithm semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, ThingMLPackage.Literals.PFA_MODEL_ALGORITHM__PFA_PATH) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ThingMLPackage.Literals.PFA_MODEL_ALGORITHM__PFA_PATH));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_PMML_ModelAlgorithm(ISerializationContext context, PMML_ModelAlgorithm semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ThingMLPackage.Literals.DATA_ANALYTICS_MODEL_ALGORITHM__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ThingMLPackage.Literals.DATA_ANALYTICS_MODEL_ALGORITHM__NAME));
			if (transientValues.isValueTransient(semanticObject, ThingMLPackage.Literals.PMML_MODEL_ALGORITHM__PMML_PATH) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ThingMLPackage.Literals.PMML_MODEL_ALGORITHM__PMML_PATH));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	/**
	 * Contexts:
	 *     DataAnalyticsModelAlgorithm returns RandomForest
	 *     ML2_ModelAlgorithm returns RandomForest
