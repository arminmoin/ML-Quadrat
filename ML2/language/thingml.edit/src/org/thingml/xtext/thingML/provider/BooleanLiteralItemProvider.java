...
/**
 * This is the item provider adapter for a {@link org.thingml.xtext.thingML.BooleanLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanLiteralItemProvider extends LiteralItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BooleanLiteral_boolValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BooleanLiteral_boolValue_feature", "_UI_BooleanLiteral_type"),
				 ThingMLPackage.eINSTANCE.getBooleanLiteral_BoolValue(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_BooleanLiteral_type") + " " + booleanLiteral.isBoolValue();
	}
