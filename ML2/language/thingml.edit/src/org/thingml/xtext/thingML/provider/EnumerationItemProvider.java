...
/**
 * This is the item provider adapter for a {@link org.thingml.xtext.thingML.Enumeration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationItemProvider extends TypeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getEnumeration_TypeRef());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getEnumeration_Literals());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getEnumeration_TypeRef(),
				 ThingMLFactory.eINSTANCE.createTypeRef()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getEnumeration_Literals(),
				 ThingMLFactory.eINSTANCE.createEnumerationLiteral()));
	}
