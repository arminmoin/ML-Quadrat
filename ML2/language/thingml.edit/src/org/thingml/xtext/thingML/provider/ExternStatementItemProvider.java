...
/**
 * This is the item provider adapter for a {@link org.thingml.xtext.thingML.ExternStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExternStatementItemProvider extends ActionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ExternStatementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExternStatement_statement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExternStatement_statement_feature", "_UI_ExternStatement_type"),
				 ThingMLPackage.eINSTANCE.getExternStatement_Statement(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getExternStatement_Segments());
		}
	...
	/**
	 * This returns ExternStatement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExternStatement"));
	}
	...
	public String getText(Object object) {
		String label = ((ExternStatement)object).getStatement();
		return label == null || label.length() == 0 ?
			getString("_UI_ExternStatement_type") :
			getString("_UI_ExternStatement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExternStatement.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getExternStatement_Segments(),
