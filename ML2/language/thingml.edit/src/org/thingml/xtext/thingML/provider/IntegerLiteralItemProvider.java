...
/**
 * This is the item provider adapter for a {@link org.thingml.xtext.thingML.IntegerLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerLiteralItemProvider extends LiteralItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerLiteral_intValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerLiteral_intValue_feature", "_UI_IntegerLiteral_type"),
				 ThingMLPackage.eINSTANCE.getIntegerLiteral_IntValue(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_IntegerLiteral_type") + " " + integerLiteral.getIntValue();
	}
