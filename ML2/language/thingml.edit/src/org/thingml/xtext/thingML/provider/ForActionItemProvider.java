...
public class ForActionItemProvider extends ActionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getForAction_Variable());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getForAction_Index());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getForAction_Array());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getForAction_Action());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getForAction_Variable(),
				 ThingMLFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getForAction_Index(),
				 ThingMLFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getForAction_Array(),
				 ThingMLFactory.eINSTANCE.createPropertyReference()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getForAction_Action(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ThingMLPackage.eINSTANCE.getForAction_Variable() ||
			childFeature == ThingMLPackage.eINSTANCE.getForAction_Index();
