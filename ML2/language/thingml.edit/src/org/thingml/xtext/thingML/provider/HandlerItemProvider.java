...
public class HandlerItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getHandler_Event());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getHandler_Guard());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getHandler_Action());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getHandler_Event(),
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getHandler_Guard(),
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getHandler_Action(),
