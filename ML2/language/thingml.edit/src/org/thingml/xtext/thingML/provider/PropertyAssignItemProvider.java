...
public class PropertyAssignItemProvider extends AnnotatedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ThingMLPackage.eINSTANCE.getPropertyAssign_Property(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getPropertyAssign_Index());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getPropertyAssign_Init());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getPropertyAssign_Index(),
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getPropertyAssign_Init(),
				 ThingMLFactory.eINSTANCE.createExpression()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ThingMLPackage.eINSTANCE.getPropertyAssign_Index() ||
			childFeature == ThingMLPackage.eINSTANCE.getPropertyAssign_Init();
