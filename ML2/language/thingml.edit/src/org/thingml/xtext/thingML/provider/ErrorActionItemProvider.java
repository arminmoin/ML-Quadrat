...
/**
 * This is the item provider adapter for a {@link org.thingml.xtext.thingML.ErrorAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ErrorActionItemProvider extends ActionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ErrorActionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ErrorAction_line_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ErrorAction_line_feature", "_UI_ErrorAction_type"),
				 ThingMLPackage.eINSTANCE.getErrorAction_Line(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getErrorAction_Msg());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ErrorAction"));
	}
	...
	public String getText(Object object) {
		ErrorAction errorAction = (ErrorAction)object;
		return getString("_UI_ErrorAction_type") + " " + errorAction.isLine();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ErrorAction.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getErrorAction_Msg(),
