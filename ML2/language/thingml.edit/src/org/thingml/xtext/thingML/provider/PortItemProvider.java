...
/**
 * This is the item provider adapter for a {@link org.thingml.xtext.thingML.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSendsPropertyDescriptor(object);
			addReceivesPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_sends_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_sends_feature", "_UI_Port_type"),
				 ThingMLPackage.eINSTANCE.getPort_Sends(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addReceivesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_receives_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_receives_feature", "_UI_Port_type"),
				 ThingMLPackage.eINSTANCE.getPort_Receives(),
				 true,
				 false,
				 true,
				 null,
