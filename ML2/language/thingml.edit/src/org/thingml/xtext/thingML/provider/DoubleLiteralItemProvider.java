...
/**
 * This is the item provider adapter for a {@link org.thingml.xtext.thingML.DoubleLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DoubleLiteralItemProvider extends LiteralItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DoubleLiteral_doubleValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DoubleLiteral_doubleValue_feature", "_UI_DoubleLiteral_type"),
				 ThingMLPackage.eINSTANCE.getDoubleLiteral_DoubleValue(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_DoubleLiteral_type") + " " + doubleLiteral.getDoubleValue();
	}
