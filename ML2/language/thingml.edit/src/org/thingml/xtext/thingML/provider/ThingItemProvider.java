...
public class ThingItemProvider extends TypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ThingMLPackage.eINSTANCE.getThing_Fragment(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ThingMLPackage.eINSTANCE.getThing_Includes(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getThing_Messages());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getThing_Ports());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getThing_Properties());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getThing_Functions());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getThing_Assign());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getThing_DataAnalytics());
			childrenFeatures.add(ThingMLPackage.eINSTANCE.getThing_Behaviour());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getThing_Messages(),
				 ThingMLFactory.eINSTANCE.createMessage()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getThing_Ports(),
		...
		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getThing_Properties(),
				 ThingMLFactory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getThing_Functions(),
				 ThingMLFactory.eINSTANCE.createFunction()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getThing_Assign(),
				 ThingMLFactory.eINSTANCE.createPropertyAssign()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getThing_DataAnalytics(),
				 ThingMLFactory.eINSTANCE.createDataAnalytics()));

		newChildDescriptors.add
			(createChildParameter
				(ThingMLPackage.eINSTANCE.getThing_Behaviour(),
