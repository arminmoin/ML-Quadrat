...
/**
 * This is the item provider adapter for a {@link org.thingml.xtext.thingML.Instance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstanceItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Instance_type_feature", "_UI_Instance_type"),
				 ThingMLPackage.eINSTANCE.getInstance_Type(),
				 true,
				 false,
				 true,
				 null,
