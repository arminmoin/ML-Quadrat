...
public class ThingMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ThingMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMin_samples_split_typeAccess().getAlternatives(), "rule__Min_samples_split_type__Alternatives");
			...
			builder.put(grammarAccess.getDecisionTreeCriterionAccess().getAlternatives(), "rule__DecisionTreeCriterion__Alternatives");
			builder.put(grammarAccess.getRandomForestCriterionAccess().getAlternatives(), "rule__RandomForestCriterion__Alternatives");
			...
			builder.put(grammarAccess.getDecisionTreeAccess().getDecisionTreeCriterionAssignment_3_1(), "rule__DecisionTree__DecisionTreeCriterionAssignment_3_1");
			...
			builder.put(grammarAccess.getRandomForestAccess().getRandomForestCriterionAssignment_3_1(), "rule__RandomForest__RandomForestCriterionAssignment_3_1");
			...
			builder.put(grammarAccess.getNN_MultilayerPerceptronAccess().getNo_hidden_layersAssignment_3_1(), "rule__NN_MultilayerPerceptron__No_hidden_layersAssignment_3_1");
			builder.put(grammarAccess.getNN_MultilayerPerceptronAccess().getActivationAssignment_5_1(), "rule__NN_MultilayerPerceptron__ActivationAssignment_5_1");
			builder.put(grammarAccess.getNN_MultilayerPerceptronAccess().getOptimizerAssignment_7_1(), "rule__NN_MultilayerPerceptron__OptimizerAssignment_7_1");
			builder.put(grammarAccess.getNN_MultilayerPerceptronAccess().getLossAssignment_9_1(), "rule__NN_MultilayerPerceptron__LossAssignment_9_1");
			builder.put(grammarAccess.getNN_MultilayerPerceptronAccess().getEpochsAssignment_11_1(), "rule__NN_MultilayerPerceptron__EpochsAssignment_11_1");
			builder.put(grammarAccess.getNN_MultilayerPerceptronAccess().getBatch_sizeAssignment_13_1(), "rule__NN_MultilayerPerceptron__Batch_sizeAssignment_13_1");
