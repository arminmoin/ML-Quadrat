...
public class ThingActionCompiler {
    ...
    public void generate(Action action, StringBuilder builder, Context ctx) {
        ...
        else if (action instanceof DASaveAction) //ML2
            generate((DASaveAction) action, builder, ctx);
        else if (action instanceof DAPreprocessAction) //ML2
            generate((DAPreprocessAction) action, builder, ctx);
        else if (action instanceof DATrainAction) //ML2
    ...
    public void generate(DAPreprocessAction action, StringBuilder builder, Context ctx) { //ML2
		throw (new UnsupportedOperationException("This action (" + action.getClass().getName() + ") is platform-specific and should be refined!"));
	}
    
    public void generate(DATrainAction action, StringBuilder builder, Context ctx) { //ML2
		throw (new UnsupportedOperationException("This action (" + action.getClass().getName() + ") is platform-specific and should be refined!"));
	}
