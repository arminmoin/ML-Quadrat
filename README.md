...
conda activate ml2
conda install nb_conda jupyter jupyter_contrib_nbextensions numpy pandas matplotlib scikit-learn scikit-learn-intelex tensorflow-gpu gensim keras pytorch
